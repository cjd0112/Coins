...
namespace Test3
{
    public class Printer
    {
        ...
        public static Int64 CalculateTotalCoinsForEachComboAndReturnCount(Int64[] arr, int valueForAssert, (int value, int multiple) n1)
        {
            Console.WriteLine($"{n1.multiple},TotalCoins");

            var g = n1.value / n1.multiple;
            arr[g]++;
        ...
        {
            Console.WriteLine($"{n1.multiple},{n2.multiple},TotalCoins");
            ...
            for (var j = 0; j < n1.value; j++)
            {
                ...
                arr[g]++;
                Console.WriteLine($"{j_coins},{k_coins},{g}");
            }
            return cnt;
        }
        ...
        {
            Console.WriteLine($"{n1.multiple},{n2.multiple},{n3.multiple},{n4.multiple},{n5.multiple},TotalCoins");
            var transitionFactor1 = n1.multiple / n2.multiple;
            var transitionFactor2 = n2.multiple / n3.multiple;
            var transitionFactor3 = n3.multiple / n4.multiple;
                ...
                for (var k = 0; k < n2.value - tf1; k++)
                {
                    ...
                    for (var l = 0; l < n3.value - tf2; l++)
                    {
                        ...
                        for (var m = 0; m < n4.value - tf3; m++)
                        {
                            ...
                            Console.WriteLine($"{j_coins},{k_coins},{l_coins},{m_coins},{n_coins},{g}");
